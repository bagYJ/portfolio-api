 ...
 * @property float|null $at_pg_sales_tax
 * @property float|null $at_cpn_sales
 * @property float|null $at_cpn_sales_tax
 * @property float|null $at_cash_sales
 * @property float|null $at_cash_sales_tax
 *
 * @package App\Models
 */
class CalculateList extends Model
{
    ...
    protected $casts = [
        ...
        'at_pg_sales' => 'float',
        'at_pg_sales_tax' => 'float',
        'at_cpn_sales' => 'float',
        'at_cpn_sales_tax' => 'float',
        'at_cash_sales' => 'float',
        'at_cash_sales_tax' => 'float'
    ];
