...
class NicepayLite
{
    ...
    public $m_LicenseKey;
    public $m_EncodeKey;
    public $m_NetCancelPW;
    public $m_NetCancelAmt;
    ...
    public $m_RejectReason;        // 구매거절 사유
    public $m_RefundAccount;        // 환불계좌번호
    public $m_RefundBankCode;        // 환불계좌은행코드
    public $m_RefundName;            // 환불계좌주명
        ...
        if (trim($this->m_ActionType) == "CLO") {
            ...
            if (trim($this->m_ActionType) == "DPO") {
                ...
                if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "BILL") {
                    ...
                    if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "MOBILE_BILLING") {
                        ...
                        if ($this->m_charSet == "UTF8") {
                            $this->m_queryString["BuyerName"] = iconv(
                                "UTF-8",
                                "EUC-KR",
                                $this->m_queryString["BuyerName"]
                            );
                            $this->m_queryString["GoodsName"] = iconv(
                                "UTF-8",
                                "EUC-KR",
                                $this->m_queryString["GoodsName"]
                            );
                        }
                        // 빌키 발급
                    } else {
                        if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "BILLKEY") {
                            ...
                            if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "ESCROW") {
                                ...
                                if ($this->m_charSet == "UTF8") {
                                    ...
                                    $this->m_queryString["RegisterName"] = iconv(
                                        "UTF-8",
                                        "EUC-KR",
                                        $this->m_RegisterName
                                    );
                                    $this->m_queryString["DeliveryCoNm"] = iconv(
                                        "UTF-8",
                                        "EUC-KR",
                                        $this->m_DeliveryCoNm
                                    );
                                    $this->m_queryString["RejectReason"] = iconv(
                                        "UTF-8",
                                        "EUC-KR",
                                        $this->m_RejectReason
                                    );
                                ...
                                if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "OM_SUB_INS") {
                                    ...
                                    if (trim($this->m_ActionType) == "PYO" && trim(
                                            $this->m_PayMethod
                                        ) == "OM_SUB_PAY") {
                                                    ...
                                                    if (trim($this->m_ActionType) == "PYO" && trim(
                                                        ...
                                                        if (trim($this->m_ActionType) == "PYO" && trim(
                                                            ...
                                                            if ($this->m_charSet == "UTF8") {
                                                                ...
                                                                $this->m_queryString["BuyerAddr"] = iconv(
                                                                    "UTF-8",
                                                                    "EUC-KR",
                                                                    $this->m_queryString["BuyerAddr"]
                                                                );
                                                                $this->m_queryString["VbankAccountName"] = iconv(
                                                                    "UTF-8",
                                                                    "EUC-KR",
                                                                    $this->m_queryString["VbankAccountName"]
                                                                );
                                                            }
                                                        }
                                                    }
